...
$$
    u_i = exp(-2.4\frac{\mu_0 - \mu_i}{\sqrt{2(\sigma_{0}^{2} + \sigma_{i}^{2})}}) + \epsilon_i
$$
...
Another idea for selection is the UCB1 formula, that weights how often we have visited a node and how promising it is.
